...
def generate_commit_message():
    ...
    return model.generate_content('''You are an expert at cerating a github commit message for a set of changes. Here is a diff of changes we need to a commit message for: ''' + git_changes)
